          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="mi-about-content">
                ...
                <p>
                  My passion is building responsive websites that
                  work well in all basic browsers. I always strive for perfection, and focus on achieving goals. I love
                  staying on the top of technologies, learning new stuff and be creative with it.
                </p>
                <ul>
